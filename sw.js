const CACHE='denisfit-v17.3.0';
const SHELL=[
  '/',
  '/styles.css?v=17.3.0',
  '/app.js?v=17.3.0',
  '/vendor/supabase.min.js?v=17.3.0',
  '/manifest.webmanifest?v=17.3.0',
  '/assets/hero-main.jpg?v=17.3.0',
  '/assets/hero-coach.png?v=17.3.0',
  '/assets/icon-192.png?v=17.3.0'
];
